...
function OneOffPurchase({ results, updateInputs }) {
  return (
    <Card
    ...
    >
      <Card.Body>
        <Card.Text>
          ...
          <div>{"\n"}</div>
          <text className="bold">{results.yearsMonthsDays3[0]}</text>{" "}
          years&#160;&#160;
          <text className="bold">{results.yearsMonthsDays3[1]}</text>{" "}
          months&#160;&#160;
          <text className="bold">{results.yearsMonthsDays3[2]}</text> days
          {/* <br />
          <br />
